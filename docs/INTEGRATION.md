...
* **Validation + Hints:** The provider fields panel surfaces inline, non-blocking warnings based on validation metadata, while required fields are checked at submit time without modal interruptions.
